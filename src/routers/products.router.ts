...
import { SearchProductsController } from '../clean/communication/controller/products/SearchProductsController'
...
productsRouter.get('/search',searchProductsController.handler.bind(searchProductsController))
